...
public class DRForm2 extends AppCompatActivity implements View.OnClickListener{
    ...
    private ImageView imageView,imageViewst,imgpan,imgpanst,imgdri,imgdrist,imgpic,imgpicst;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewst = (ImageView) findViewById(R.id.imgaadharst);
        ...
        imageViewst.setBackgroundResource(0);
    ...
    private void uploadImage(){
        ...
        imageViewst.setBackgroundResource(R.drawable.ic_baseline_cloud_upload_24);
        UploadImage ui = new UploadImage();
        ui.execute(bitmap);
    }
    @Override
    ...
    private void checkDriverRegistration() {
        ...
        try
        {
            ...
            int count = 0;
            Integer aadhar,pancard,drivingno,selfpic = null;
            for(count=0;count<jsonArray.length();count++)
            {
                ...
                if(aadhar==2){
                    imageViewst.setBackgroundResource(R.drawable.ic_baseline_verified_user_24);
                } else if(aadhar==3)
                    {
                        imageViewst.setBackgroundResource(R.drawable.ic_baseline_cancel_24);
                    }
                else if(aadhar==1)
                {
                    imageViewst.setBackgroundResource(R.drawable.ic_baseline_cloud_done_24);
                }
